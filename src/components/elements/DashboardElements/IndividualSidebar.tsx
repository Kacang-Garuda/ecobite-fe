...
const IndividualSidebar: React.FC<SidebarProps> = ({
  ...
  <div className='flex flex-col gap-2 dashboard-container py-4 px-6 w-[18.4375rem] font-medium h-max'>
    <button className='flex flex-row gap-2 items-center' onClick={onEditProfileClick}>
      <img src="/images/people-icon.svg" alt="People Icon" className='pr-2 w-8' />Edit Profile
    </button>
    <button className='flex flex-row gap-2 items-center' onClick={onMyDonationClick}>
      <img src="/images/dashboard/suit-heart-fill.svg" alt="Suit Heart Icon" className='pr-2 w-8' />My Donation
    </button>
    <button className='flex flex-row gap-2 items-center' onClick={onFoodBookedClick}>
      <img src="/images/dashboard/cutlery-fill.svg" alt="Cutlery Icon" className='pr-2 w-8' />Food Booked
    </button>
    <button className='flex flex-row gap-2 items-center' onClick={onVolunteerClick}>
