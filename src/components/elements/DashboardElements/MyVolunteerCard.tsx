...
const MyVolunteerCard: React.FC<VolunteerCardProps> = ({ id,img, title, date, city, status }) => {
    return (
        ...
        <div className='flex flex-col'>
            ...
            <div className='flex flex-row gap-20'>
                <div className='flex gap-1'>
                    <img src="/images/dashboard/calendar-fill.svg" alt="Calendar Icon" />
                    <p>{date}</p>
                </div>
                <div className='flex gap-1'>
            ...
            <div className='flex self-end'>
                ...
                :
                <button className={`flex px-2 py-2 justify-center items-center gap-2.5 text-xs rounded-lg font-semibold bg-[#EB5757] text-white`}>
                    Rejected
                </button>
                )}
            </div>
