        ...
        <div className="inline-flex items-start gap-6 font-semibold">
          {isLoading ? (
            ...
            >
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 w-full bg-white border border-gray-200 rounded-md shadow-lg">
                  <div className="font-normal">
                    <a
                      href="/dashboard"
                      className={`flex items-center p-2 hover:bg-gray-100 ${getMenuItemClass('/profile/myfood')}`}
                    >
                      <img
                    ...
                    <a
                      href="#"
                      className="flex items-center p-2 text-[#EB5757] hover:bg-gray-100"
