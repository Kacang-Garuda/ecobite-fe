...
const HeroSection = () => {
  ...
  const paragraphs = [
    ...
    {
      header:
        "Every year, <span class='font-bold'>Indonesia</span> discards food worth",
            ...
            >
              <p
                ...
                dangerouslySetInnerHTML={{
                  __html: paragraphs[currentIndex].header,
                }}
              ></p>
              <p className={`text-8xl font-black text-[#02353C]`}>
                {paragraphs[currentIndex].percentage}
              </p>
              <p
                className="text-5xl leading-tight"
                dangerouslySetInnerHTML={{
                  __html: paragraphs[currentIndex].text,
                }}
              ></p>
            </motion.div>
          </AnimatePresence>
