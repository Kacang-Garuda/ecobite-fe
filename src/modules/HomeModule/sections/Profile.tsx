  ...
  <div className='relative flex flex-col w-full h-max bg-white'>
    <div className='flex flex-col px-36 py-24 items-center gap-12'>
        ...
        <div className='flex flex-row w-full gap-[5.75rem] items-center'>
            ...
            At EcoBite, we believe in turning excess into opportunity. Our commitment ensures no food goes to waste while addressing hunger 
            in our community. Help us transform your surplus food into valuable meals for those who need them most. Join our effort to share 
