      ...
      <div className='relative flex flex-col flex-grow items-center justify-center bg-white px-40 py-20 font-bold gap-8'>
        <div className='w-full flex flex-row justify-center relative py-4'>
          <div className='absolute left-0'>
            <button className='hover:scale-110 transition ease-in-out' onClick={() => router.back()}>
        ...
        <div className='flex flex-col gap-1 text-center text-[#333]'>
          <p className='text-2xl'>Please check your inbox and confirm your email address.</p>
          <p className='text-xl font-normal'>We’ve sent a confirmation email to {user?.email}</p>
        </div>
        <div className='bg-[#188290] rounded-lg bg-opacity-10 flex flex-col py-5 px-6 gap-4'>
          <div className='flex flex-row gap-3'>
            <img src="/images/authentication/info-circle-fill.svg" alt="Info Warn" />
            <p className='text-xl font-semibold'>Didn’t receive an email?</p>
          </div>
          <div className='max-w-xl'>
            <p className='text-lg font-normal'>If you can’t find the email in your inbox or spam folder, please click the button below and we will send you a new one.</p>
          </div>
