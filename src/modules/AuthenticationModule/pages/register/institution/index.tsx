...
const RegisterInstitution: React.FC<RegisterInstitutionProps> = ({ onBack }) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea rows={6} {...field} className="w-full" placeholder='Enter your organization description'/>
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                  ...
                  <FormControl>
                    <div className="relative w-full">
                      ...
                      >
                        ...
                        <span className={qrisFileName ? 'text-black' : 'text-[#188290]'}>
