      ...
      <div className='relative flex flex-col flex-grow items-center justify-center bg-white px-40 py-20 font-bold'>
        <div className='w-full flex flex-row justify-center relative py-12'>
          ...
          <div className='flex justify-center items-center pt-4 flex-col gap-3'>
            ...
            <p className='font-semibold text-lg'>Don’t have an account yet? <a className='text-[#188290] hover:text-[#02353C]' href='/register'>Sign up now</a></p>
          </div>
        </div>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='w-1/2 gap-6 flex flex-col font-normal'>
            <FormField
